...
if(isset($_SESSION['admin_email'])==true){
    ...
    $get_ditails="select * from admin where email='$admin_email'";
	...
	$get_all_pro="select * from products order by 1 DESC";
...
<nav class="navbar navbar-inverse navbar-fixed-top" style="background:#01030d">
    <div class="navbar-header" style="padding:0">
        ...
        <a href="index.php?dashboard" class="navbar-brand">  <i class="fa fa-bandcamp"> </i>  Admin Panal</a>
    </div>
    <!-- nav bar right start -->
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav sidebar-nav">
            ...
            <li><!--start here-->
            <a href="#" data-toggle="collapse" data-target="#slidermenu">
              <i class="fa fa-image"></i> Slider <i class="fa fa-caret-down"></i> 
            </a>
                <ul id="slidermenu" class="collapse">
                    <li>
                        <a href="index.php?insert_slider"><i class="fa fa-upload"></i> Insert slider</a>
                    </li>
                    <li>
                        <a href="index.php?view_slider"><i class="fa fa-eye"></i>   View slider</a>
                    </li>
            ...
            <a href="#" data-toggle="collapse" data-target="#user">
              <i class="fa fa-user"></i> Users <i class="fa fa-caret-down"></i> 
            </a>
                <ul id="user" class="collapse">
                    <li>
                        <a href="index.php?insert_user"><i class="fa fa-upload"></i> Insert user</a>
                    </li>
                    <li>
                        <a href="index.php?view_user"><i class="fa fa-eye"></i>       View user</a>
                    </li>
