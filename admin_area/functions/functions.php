...
function insert_products(){
        ...
        $admin_job=$_SESSION['admin_job'];
	$get_cust_id="select * from customer ";
    ...
    move_uploaded_file($temp_name1, "../seller_ac/product_images/$product_img1");
    move_uploaded_file($temp_name2, "../seller_ac/product_images/$product_img2");
    move_uploaded_file($temp_name3, "../seller_ac/product_images/$product_img3");
                ...
                <div class="panel-body">
                    <form action="index.php?insert_product" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-md-3 control-lable">Customer Id</label>
...
?><div class="row"><center>
                <ul class="pagination">
                    ...
                    $query="select * from products";
                        ...
                        echo"
                            <li><a href='index?view_pro_page=$total_pages'>".'Last Page'." </a> </li>
                        ";
